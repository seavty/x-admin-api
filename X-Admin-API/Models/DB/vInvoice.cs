...
namespace X_Admin_API.Models.DB
{
    ...
    public partial class vInvoice
    {
        ...
        public Nullable<int> salm_SalesmanID { get; set; }
        public string salm_Deleted { get; set; }
        public Nullable<int> salm_CreatedBy { get; set; }
        public Nullable<System.DateTime> salm_CreatedDate { get; set; }
        public Nullable<int> salm_UpdatedBy { get; set; }
        public Nullable<System.DateTime> salm_UpdatedDate { get; set; }
        public Nullable<int> salm_WorkflowID { get; set; }
        public Nullable<int> salm_WorkflowItemID { get; set; }
        public Nullable<int> salm_ZoneID { get; set; }
        public string salm_Name { get; set; }
        public string salm_Code { get; set; }
        public Nullable<int> salm_ParentID { get; set; }
        public string salm_Phone { get; set; }
        public string salm_CompanyPhone { get; set; }
    }
}
